...
flags.DEFINE_string("vocab_file", './ModelParams/chinese_L-12_H-768_A-12/vocab.txt',
...
flags.DEFINE_string('data_config_path', './Config/NER/ner_data.conf',
...
#                             init_string)
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            def metric_fn(label_ids, pred_ids):
                ...
                # indice参数告诉评估矩阵评估哪些标签,与label_list相对应
                indices = [2, 3, 4, 5, 6, 7]
                weight = tf.sequence_mask(FLAGS.max_seq_length)
                precision = tf_metrics.precision(
                    label_ids, pred_ids, num_labels, indices, weight)
